...
export const projects: Project[] = [
  ...
  // },
  {
    ...
    category: ['program'],
    url: 'https://heroes-and-champions.vercel.app/',
    media: '/data/images/heroesandchampions.png',
    github: 'https://github.com/NickCorfmat/heroes-and-champions',
    shortDescription: 'Full-stack e-commerce comic store website.',
    description: '',
    teamSize: 1,
